                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="datatable-buttons"
                                ...
                                $fetch_stock_no = $db_handle->numRows("SELECT * FROM `primary_stock`, `product` WHERE primary_stock.product_id = product.product_id order by primary_stock.p_stock_id DESC");
